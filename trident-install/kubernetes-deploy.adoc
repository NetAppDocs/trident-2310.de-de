...
[%collapsible]
====
Mit Astra Trident unter Verwendung der NetApp Console ist ein Upgrade auf die neueste Version von Astra Trident möglich, das Hinzufügen und Verwalten von Storage-Klassen sowie deren Verbindung mit Arbeitsumgebungen und das Sichern von persistenten Volumes mithilfe des Cloud Backup Service. BlueXP unterstützt die Bereitstellung von Astra Trident mithilfe des Trident Operators, entweder manuell oder mit Helm.
