...
TIP: Weitere Informationen zur Astra Trident Architektur auf dem Kubernetes Cluster sind unter link:../trident-get-started/architecture.html["Die Architektur von Astra Trident"] zu finden.
