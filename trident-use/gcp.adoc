...
Astra Trident kann Cloud Volumes Service Volumes in einem von zwei link:https://docs.cloud.google.com/netapp/volumes/docs/discover/overview["Servicetypen"^] erstellen:
